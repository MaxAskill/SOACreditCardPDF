...
//   );
//   $formattedAmount = number_format($converted_amount, 2, '.', ',');
...
<!-- export button -->
<a href="export1.php?tbSaleDate=<?php echo urlencode(serialize($tbSaleDate));?>
                    ...
                    &newTransactionCtr<?php echo urlencode(serialize($newTransactionCtr))?>
        ...
        if($x >= $counterarray){
          ...
          echo "<tr>";
            ...
            // if (preg_match('/(SINGAPORE DOLLARS)\s.*?/', $transaction))
              ...
              // $response = convertCurrency($from_currency,$to_currency,$amount); // Getting the convertion amount
